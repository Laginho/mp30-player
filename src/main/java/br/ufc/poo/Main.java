...
public class Main {
    public static void main(String[] args) {
        ...
        // em modo debug
        Musica md1 = new Musica("Bohemian Rhapsody", 355, "Queen", "A Night at the Opera");
        Musica md2 = new Musica("Hotel California", 390, "Eagles", "Hotel California");
        Musica md3 = new Musica("Stairway to Heaven", 480, "Led Zeppelin", "Led Zeppelin IV");
        ...
        player.proxima();
        dormir(3); // Espera 3 segundos para você ouvir um pouco
